...
kthoom.google = {
    ...
    doDrive: function () {
        if (!kthoom.google.authed) {
            ...
            var picker = new google.picker.PickerBuilder().addView(docsView).// Enable this feature when we can efficiently get downloadUrls
            ...
            enableFeature(google.picker.Feature.NAV_HIDDEN).setOAuthToken(kthoom.google.oathToken).setDeveloperKey(kthoom.google.apiKey).setAppId(kthoom.google.clientId).setCallback(kthoom.google.pickerCallback).build();
